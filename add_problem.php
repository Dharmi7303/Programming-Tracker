        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Add problem</span>
                </div>

                <div class="boxes">
                    <div class="box box1">
                        <i class="uil uil-share"></i>
                        <span class="text">Current Problems</span>
                        <span class="number">
                        <?php
            ...
            <div class="activity">
            <form action="addprob.php" method="post" enctype="multipart/form-data">
            <?php
            if(isset($message)){
            ...
            ?>
            <input type="text" name="name" placeholder="Problem name" class="box" required>
            <input type="text" name="description" placeholder="Description" class="box" required>
            <input type="text" name="contestid" placeholder="Contest ID" class="box" required>
            <input type="submit" name="submit" value="Add Problem" class="btn">
        </form>
            </div>
        </div>
    </section>
