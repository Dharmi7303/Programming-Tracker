                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        foreach($query_run as $items)
                        {
                            ...
                            <tr>
                                ...
                                <td><?= $items['email']; ?></td>
                                <td><?= $items['datejoin']; ?></td>
                                <td><a href="admin_update_user.php?id=<?= $items['id']; ?>" class="btn btn-primary">Update</a></td>
                                <td><a href="delete_user.php?id=<?= $items['id']; ?>" class="btn btn-danger">Delete</a></td>
